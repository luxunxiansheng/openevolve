...
from openevolve.evaluation.orchestrator import RayEvaluationOrchestrator

class TestOrchestrator(unittest.TestCase):
    def setUp(self):
                
        self.orchestrator = RayEvaluationOrchestrator(ray_cluster_head_ip="http://localhost:8265")
